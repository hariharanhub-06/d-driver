...
router.get('/:id/stops', requireRole('admin', 'super_admin', 'driver'), requireSchoolScope, getRouteWithStops);
router.get('/:id', requireRole('admin', 'super_admin', 'driver'), requireSchoolScope, getRouteById);
