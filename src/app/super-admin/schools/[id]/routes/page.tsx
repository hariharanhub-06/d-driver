                ...
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[9999] flex items-center justify-center p-4">
                    <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-md">
                        ...
                        <div className="flex gap-3 px-6 pb-6">
                            {editing && (
                                <button onClick={() => { const r = editing; setModalOpen(false); if (r) handleDelete(r); }} className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-600 dark:text-red-400 rounded-xl px-4 py-2.5 font-semibold text-sm hover:bg-red-100 dark:hover:bg-red-900/40 transition-colors">
                                    {t('Delete', 'நீக்கு')}
                                </button>
                            )}
