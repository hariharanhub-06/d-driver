        ...
        <div className="bg-[#121212] rounded-[32px] shadow-2xl overflow-hidden border border-white/5 relative">
          ...
          <div className="p-6 pt-8 text-center relative overflow-hidden">
            ...
            <div className="w-16 h-16 bg-white rounded-2xl mx-auto flex items-center justify-center shadow-2xl mb-4 border border-white/10 p-3">
              <KeyRound className="w-8 h-8 text-black" strokeWidth={1.5} />
            </div>
          ...
          <div className="p-8 pt-2">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
              ...
              <button
                ...
                className="w-full bg-white hover:bg-white/90 text-black font-black py-4 px-6 rounded-[18px] transition-all flex justify-center items-center h-[56px] text-lg active:scale-[0.98] shadow-2xl overflow-hidden group mt-4 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isLoading ? (
...
export default function ResetPasswordPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-black flex items-center justify-center"><div className="w-8 h-8 border-4 border-blue-500/30 border-t-blue-500 rounded-full animate-spin"></div></div>}>
